...
{
	StateAVX k1, k2, k3, k4, k5, k6, s1, s2, s3, s4, s5, s6, sol;
	...
	s1 = derivativeAVX(r,par);
	k1 = H*s1;

	s2 = derivativeAVX(r+b[2][1]*k1,par); 
	k2 = H*s2;

	s3 = derivativeAVX(r+b[3][1]*k1+b[3][2]*k2,par);
	k3 = H*s3;

	s4 = derivativeAVX(r+b[4][1]*k1+b[4][2]*k2+b[4][3]*k3,par);
	k4 = H*s4;

	s5 = derivativeAVX(r+b[5][1]*k1+b[5][2]*k2+b[5][3]*k3+b[5][4]*k4,par);
	k5 = H*s5;

	s6 = derivativeAVX(r+b[6][1]*k1+b[6][2]*k2+b[6][3]*k3+b[6][4]*k4+b[6][5]*k5,par);
	k6 = H*s6;

	sol = r+c[1]*k1+c[3]*k3+c[4]*k4+c[6]*k6;
